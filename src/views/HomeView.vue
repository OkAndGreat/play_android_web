<template>
    <div class="home wrapper">
        ...
        <div class="main_left">
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img :src="BannerList[0].imagePath" class="d-block w-100"
                             @click="onUrlClicked(BannerList[0].url)"
                             alt="banner">
                    </div>
                    <div class="carousel-item">
                        <img :src="BannerList[1].imagePath" class="d-block w-100"
                             @click="onUrlClicked(BannerList[1].url)"
                             alt="banner">
                    </div>
                    <div class="carousel-item">
                        <img :src="BannerList[2].imagePath" class="d-block w-100"
                             @click="onUrlClicked(BannerList[2].url)"
                             alt="banner">
                    </div>
                </div>
            ...
            <div class="content">
                <div class="left">
                    <div class="hr" @click="onUrlClicked('https://www.wanandroid.com/blog/show/2949')">
                        站长在线招Android！
                    </div>
